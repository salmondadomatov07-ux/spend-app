...
tj:{
  balance:"Баланси умумӣ",
  income:"Даромад",
  expense:"Хароҷот",
  debt_given:"Қарз додам",
  debt_taken:"Қарз гирифтам",
  monthly:"Ҳисоботи моҳона",
  chart:"График",
  recent:"Транзаксияҳои охир",
  see_all:"Ҳама",
  no_txn:"Ҳоло транзаксия нест",
  all_txn:"Ҳама транзаксияҳо",
  goals:"Мақсадҳо",
  no_goal:"Ҳоло мақсад нест",
  add:"Илова", save:"Сабт",
  cancel:"Бекор", delete:"Нест",
  amount:"Маблағ", cat:"Категория",
  date:"Сана", note:"Шарҳ", tags:"Тегҳо",
  repeat:"Такрор", no_repeat:"Не",
  daily:"Ҳар рӯз", weekly:"Ҳар ҳафта",
  monthly_r:"Ҳар моҳ",
  to_who:"Ба кӣ", from_who:"Аз кӣ",
  note_exp:"Масалан: маош гирифтам",
  note_inc:"Масалан: маош гирифтам",
  note_dg:"Масалан: ба дӯстам",
  note_dt:"Масалан: аз дӯстам",
  person_dg:"Масалан: Алӣ",
  person_dt:"Масалан: Дониёр",
  receipt:"Чек", share_txt:"Мубодила",
  profile:"Профил", name:"Ном",
  save_profile:"Профил сабт",
  language:"Забон", interface:"Интерфейс",
  theme:"Мавзӯ", currency:"Асъор",
  notif:"Огоҳҳо", push:"Push-огоҳҳо",
  notif_off:"Хомӯш", notif_on:"Фаъол",
  notif_time:"Вақти ёдоварӣ",
  security:"Амният", pin:"Рамзи PIN",
  pin_not_set:"Танзим нашудааст",
  pin_set:"Танзим шудааст",
  set_pin:"Танзим кун",
  change_pin:"Иваз кун",
  remove_pin:"PIN нест кун",
  custom_cats:"Категорияҳои шахсӣ",
  new_cat:"Категорияи нав",
  family:"Буҷети оилавӣ",
  add_member:"Аъзо илова",
  data:"Маълумот",
  export:"Содирот (JSON)",
  import_data:"Воридот",
  reset:"Ҳама маълумот нест",
  about:"Дар бораи барнома",
  avatar:"Аватар интихоб",
  confirm:"Тасдиқ",
  delete_q:"Шумо мутмаин ҳастид?",
  nav_home:"Асосӣ",
  nav_budget:"Буҷет",
  nav_goals:"Мақсад",
  nav_settings:"Танзимот",
  ai_title:"Маслаҳатгар",
  ai_welcome:"Салом! Ман ёрдамчии AI SpendUZ ҳастам. Савол диҳед!",
  ai_q1:"Таҳлили хароҷот",
  ai_q2:"Маслаҳат",
  ai_q3:"Нақша",
  ai_q4:"Хароҷоти асосӣ",
  pin_enter:"Рамзи PIN ворид",
  pin_wrong:"PIN нодуруст!",
  pin_forgot:"PIN фаромӯш",
  pin_attempts:"уриниш мондат",
  pin_wait:"дақиқа сабр",
  pin_setup:"PIN танзим",
  pin_new:"PIN-и нав ворид кунед",
  pin_confirm:"PIN такрор",
  pin_mismatch:"PIN мувофиқ нест!",
  pin_saved:"PIN танзим шуд!",
  pin_removed:"PIN нест шуд",
  pin_reset_label:"Коди аз бот ворид кунед",
  pin_reset_sent:"Код ба @Spend_uz_bot фиристода шуд.",
  pin_reset_wrong:"Код нодуруст!",
  pin_reset_ok:"PIN барқарор шуд!",
  add_goal:"Мақсад илова",
  goal_done:"Мақсад иҷро шуд! Муборак!",
  saved:"Сабт шуд!", updated:"Навсозӣ шуд!",
  deleted:"Нест шуд",
  login_sub:"Молияи худро касабона идора кунед",
  login_start:"Оғоз",
  fill_all:"Ҳама майдонҳоро пур кунед!",
  enter_name:"Номро ворид кунед!",
  select_cat:"Категория интихоб!",
  enter_amount:"Маблағ ворид!",
  enter_date:"Сана ворид!",
  ai_no_data:"Ҳоло транзаксия нест.",
  no_custom_cats:"Категорияҳои шахсӣ нест",
  no_family:"Ҳоло аъзо нест",
  export_done:"Содир шуд!", import_done:"Воридот муваффақ!",
  wrong_file:"Файли нодуруст!",
  reset_confirm:"Ин амалро баргардонидан мумкин нест!",
  notif_granted:"Огоҳҳо фаъол шуд!",
  notif_denied:"Иҷозат дода нашуд",
  profile_saved:"Профил сабт шуд!",
  avatar_changed:"Аватар иваз шуд!",
  currency_changed:"Асъор иваз шуд!",
  copied:"Нусха гирифта шуд!",
  cat_used:"Ин категория истифода мешавад!",
  cat_default:"Стандартро нест кардан мумкин нест!",
  cat_added:"Категория илова шуд!",
  member_added:"Аъзо илова шуд!",
  enter_cat_name:"Номи категорияро ворид кунед!",
  enter_member_name:"Номро ворид кунед!",
  budget_title:"Буҷет",
  no_budget:"Буҷет нест",
  budget_limit:"Лимит",
  budget_spent:"Сарфшуда",
  budget_left:"Мондат",
  pdf_ready:"PDF тайёр мешавад...",
  pdf_blocked:"Блоклашуда! Рухсат диҳед.",
  voice_fail:"Нафаҳмидам!",
  voice_no_amount:"Маблағ ёфта нашуд!",
  voice_detected:"AI муайян кард:",
  mic_no:"Браузар микрофонро қолламайди!",
}
};
...
function parseVoiceAmount(text) {
  ...
  const MLN_KW=["million","mln","mlrd","milliard","миллион","млн","миллиона","миллионов","mlrd","milyon","млрд"];
  // Thousand keywords: uz/ru/en/tj
  const MING_KW=["ming","минг","тысяч","тыс","thousand","тысячи","тысяча","хазор"];

  const hasMln=words.some(w=>MLN_KW.includes(w))||MLN_KW.some(w=>low.includes(w));
  const hasMing=words.some(w=>MING_KW.includes(w))||low.includes("ming")||low.includes("тысяч");
  ...
  // "4 000 000" or "4 000" with trailing zeros
  if(nums.length>=2&&nums.slice(1).every(n=>/^0+$/.test(n))) return[parseInt(nums.join("")),cur];
  if(nums.length===2&&nums[1]==="000") return[base*1000,cur];
  if(nums.length===3&&nums[1]==="000"&&nums[2]==="000") return[base*1_000_000,cur];
  return[base,cur];
}
...
function checkPremiumFromBot() {
  // Check premium from URL params (sent by bot)
  try {
    const params = new URLSearchParams(window.location.search);
    const prem  = params.get("premium");
    const until = params.get("until");
    if (prem === "1" && until) {
      // Bot says user is premium — update localStorage
      const untilDate = new Date(until);
      untilDate.setHours(23,59,59);
      if (untilDate > new Date()) {
        S.settings.premiumUntil = untilDate.toISOString();
        saveS();
      }
    } else if (prem === "0") {
      // Bot says not premium
      const localUntil = S.settings.premiumUntil;
      if (!localUntil || new Date(localUntil) < new Date()) {
        S.settings.premiumUntil = null;
        saveS();
      }
    }

    // Also check Telegram WebApp
    if (window.Telegram && window.Telegram.WebApp) {
      const user = window.Telegram.WebApp.initDataUnsafe && window.Telegram.WebApp.initDataUnsafe.user;
      if (user && user.id) {
        S.profile.tgId = user.id;
        saveS();
      }
    }
  } catch(e) {}
...
function getPremiumUntil() {
  return S.settings.premiumUntil || null;
}
...
function setPremiumManual(days) {
  // Called to manually set premium (e.g. after referral)
  const now = new Date();
  const until = S.settings.premiumUntil && new Date(S.settings.premiumUntil) > now
    ? new Date(S.settings.premiumUntil)
    : now;
  until.setDate(until.getDate() + days);
  S.settings.premiumUntil = until.toISOString();
  saveS();
}
...
function addPremiumDays(days) {
  const now = new Date();
  const until = getPremiumUntil();
  const base = (until && new Date(until) > now) ? new Date(until) : now;
  base.setDate(base.getDate() + days);
  S.settings.premiumUntil = base.toISOString();
  saveS();
}

function showPremiumModal() {
  const lang = S.settings.lang || "uz";
  const msgs = {
    uz: "💎 Bu funksiya Premium uchun!\n\n✅ Agar sizda Premium bor bo'lsa, botga /start yozing va app ni qayta oching.\n\n🎁 Premium olish: botga /premium yozing\n🎁 Bepul: do'st taklif → /ref",
    ru: "💎 Это функция Premium!\n\n✅ Если у вас есть Premium, напишите /start боту и откройте app заново.\n\n💎 /premium — купить\n🎁 /ref — бесплатно",
    en: "💎 This is a Premium feature!\n\n✅ If you have Premium, write /start to bot and reopen app.\n\n💎 /premium — buy\n🎁 /ref — get free",
    tj: "💎 Ин функияи Premium аст!\n\n💎 /premium — харид\n🎁 /ref — ройгон",
  };
  toast(msgs[lang] || msgs.uz, "warn");
}
...
function bindEvents() {
  ...
  // Currency
  document.getElementById("curSelect").addEventListener("change",e=>{
  const val = e.target.value;
  // Premium check: only uzs and usd for free users
  if(!isPremium() && (val === "eur" || val === "rub")){
    e.target.value = S.settings.currency || "uzs";
    showPremiumModal();
    return;
  }
  S.settings.currency=val;saveS();renderHome();toast(t("currency_changed"));
});
  // Rate bar
